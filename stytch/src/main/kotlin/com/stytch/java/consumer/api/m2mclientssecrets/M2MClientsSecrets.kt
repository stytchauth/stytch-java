...
public interface Secrets {
     ...
     * rotation flow to receive another one.
     */
    public fun rotateStart(data: RotateStartRequest, callback: (StytchResult<RotateStartResponse>) -> Unit)
     ...
     * will be valid.
     */
    public fun rotateCancel(data: RotateCancelRequest, callback: (StytchResult<RotateCancelResponse>) -> Unit)
     ...
     * `client_secret` will no longer be valid.
     */
    public fun rotate(data: RotateRequest, callback: (StytchResult<RotateResponse>) -> Unit)
...
internal class SecretsImpl(
    ...
    override fun rotateStart(data: RotateStartRequest, callback: (StytchResult<RotateStartResponse>) -> Unit) {
    ...
    override suspend fun rotateCancel(data: RotateCancelRequest): StytchResult<RotateCancelResponse> = withContext(Dispatchers.IO) {
    ...
    override fun rotateCancel(data: RotateCancelRequest, callback: (StytchResult<RotateCancelResponse>) -> Unit) {
        coroutineScope.launch {
    ...
    override suspend fun rotate(data: RotateRequest): StytchResult<RotateResponse> = withContext(Dispatchers.IO) {
    ...
    override fun rotate(data: RotateRequest, callback: (StytchResult<RotateResponse>) -> Unit) {
        coroutineScope.launch {
