...
*/
@JsonClass(generateAdapter = true)
public data class AuthenticateStartRequest @JvmOverloads constructor(
    /**
...
*/
@JsonClass(generateAdapter = true)
public data class AuthenticateStartResponse @JvmOverloads constructor(
    /**
     * Globally unique UUID that is returned with every API call. This value is important to log for debugging purposes; we
     * may ask for this value to help identify a specific API call when helping you debug an issue.
     */
...
*/
@JsonClass(generateAdapter = true)
public data class RegisterRequest @JvmOverloads constructor(
    /**
     * The `user_id` of an active user the WebAuthn registration should be tied to.
     */
    @Json(name = "user_id")
...
*/
@JsonClass(generateAdapter = true)
public data class RegisterResponse @JvmOverloads constructor(
    /**
     * Globally unique UUID that is returned with every API call. This value is important to log for debugging purposes; we
     * may ask for this value to help identify a specific API call when helping you debug an issue.
     */
...
*/
@JsonClass(generateAdapter = true)
public data class RegisterStartRequest @JvmOverloads constructor(
    /**
     * The `user_id` of an active user the WebAuthn registration should be tied to.
     */
    @Json(name = "user_id")
    ...
    /**
     * The requested authenticator type of the WebAuthn device. The two valid value are platform and cross-platform. If no
     * value passed, we assume both values are allowed.
     */
...
*/
@JsonClass(generateAdapter = true)
public data class RegisterStartResponse @JvmOverloads constructor(
    /**
     * Globally unique UUID that is returned with every API call. This value is important to log for debugging purposes; we
     * may ask for this value to help identify a specific API call when helping you debug an issue.
     */
