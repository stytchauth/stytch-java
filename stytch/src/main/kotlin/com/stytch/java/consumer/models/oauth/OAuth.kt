...
public data class ProviderValues @JvmOverloads constructor(
    /**
...
*/
@JsonClass(generateAdapter = true)
public data class AttachRequest @JvmOverloads constructor(
    /**
...
*/
@JsonClass(generateAdapter = true)
public data class AttachResponse @JvmOverloads constructor(
    /**
