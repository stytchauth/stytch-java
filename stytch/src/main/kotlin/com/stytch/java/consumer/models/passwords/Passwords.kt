...
public data class Argon2Config @JvmOverloads constructor(
    /**
     * The salt value.
     */
    @Json(name = "salt")
...
@JsonClass(generateAdapter = true)
public data class Feedback @JvmOverloads constructor(
    /**
...
@JsonClass(generateAdapter = true)
public data class LUDSRequirements @JvmOverloads constructor(
    /**
...
@JsonClass(generateAdapter = true)
public data class MD5Config @JvmOverloads constructor(
    /**
...
@JsonClass(generateAdapter = true)
public data class PBKDF2Config @JvmOverloads constructor(
    /**
...
@JsonClass(generateAdapter = true)
public data class SHA1Config @JvmOverloads constructor(
    /**
     * The salt that should be prepended to the migrated password.
     */
    @Json(name = "prepend_salt")
...
@JsonClass(generateAdapter = true)
public data class ScryptConfig @JvmOverloads constructor(
    /**
     * The salt value, which should be in a base64 encoded string form.
     */
    @Json(name = "salt")
...
*/
@JsonClass(generateAdapter = true)
public data class MigrateRequest @JvmOverloads constructor(
    /**
     * The email address of the end user.
     */
    @Json(name = "email")
...
*/
@JsonClass(generateAdapter = true)
public data class MigrateResponse @JvmOverloads constructor(
    /**
     * Globally unique UUID that is returned with every API call. This value is important to log for debugging purposes; we
     * may ask for this value to help identify a specific API call when helping you debug an issue.
     */
...
*/
@JsonClass(generateAdapter = true)
public data class StrengthCheckRequest @JvmOverloads constructor(
    /**
     * The password of the user
     */
    @Json(name = "password")
...
*/
@JsonClass(generateAdapter = true)
public data class StrengthCheckResponse @JvmOverloads constructor(
    /**
     * Globally unique UUID that is returned with every API call. This value is important to log for debugging purposes; we
     * may ask for this value to help identify a specific API call when helping you debug an issue.
     */
