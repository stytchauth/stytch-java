...
public data class StrengthCheckResponse
    ...
    constructor(
         ...
         * sophistication. We also offer [LUDS](https://stytch.com/docs/guides/passwords/strength-policy) which is less
         * sophisticated but easier to understand. If an email address is included in the call we also require that the password
         * hasn't been compromised using built-in breach detection powered by [HaveIBeenPwned](https://haveibeenpwned.com/).
         */
         ...
         * disabled in the [dashboard](https://stytch.com/dashboard/password-strength-config#breach-detection). If this value is
