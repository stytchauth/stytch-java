...
@JsonClass(generateAdapter = true)
public data class SAMLConnectionImplicitRoleAssignment @JvmOverloads constructor(
    @Json(name = "role_id")
    val roleId: String,
)
...
@JsonClass(generateAdapter = true)
public data class SAMLGroupImplicitRoleAssignment @JvmOverloads constructor(
    @Json(name = "role_id")
    val roleId: String,
    @Json(name = "group")
    val group: String,
