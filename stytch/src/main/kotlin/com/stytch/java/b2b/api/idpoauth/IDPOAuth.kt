package com.stytch.java.b2b.api.idpoauth
...
import com.stytch.java.b2b.models.idpoauth.AuthorizeResponse
import com.stytch.java.b2b.models.idpoauth.AuthorizeStartRequest
import com.stytch.java.b2b.models.idpoauth.AuthorizeStartResponse
...
public interface OAuth {
     ...
     * - `session_jwt`
     *
     * If a `session_token` or `session_jwt` is passed, the OAuth Authorization will be linked to the Member's session for
     * tracking purposes.
...
internal class OAuthImpl(
    ...
    override suspend fun authorizeStart(data: AuthorizeStartRequest): StytchResult<AuthorizeStartResponse> =
        withContext(Dispatchers.IO) {
            ...
            httpClient.post("/v1/b2b/idp/oauth/authorize/start", asJson, headers)
        }
    ...
    override suspend fun authorize(data: AuthorizeRequest): StytchResult<AuthorizeResponse> =
        withContext(Dispatchers.IO) {
            ...
            httpClient.post("/v1/b2b/idp/oauth/authorize", asJson, headers)
        }
