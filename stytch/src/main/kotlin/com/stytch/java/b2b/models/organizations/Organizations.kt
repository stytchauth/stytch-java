...
public data class Member
    ...
    constructor(
         ...
         * [OIDC Connection](https://stytch.com/docs/b2b/api/oidc-connection-object) objects the Member has authenticated with.
         */
        ...
        /**
         * A scim member registration, referencing a [SCIM Connection](https://stytch.com/docs/b2b/api/scim-connection-object)
...
public data class SearchQuery
    ...
    constructor(
         ...
         *
         *   `OR` – **[DEPRECATED]** the operator will return any matches to at least one of the operand values you supply. This
         * parameter is retained for legacy use cases only and is no longer supported. We strongly recommend breaking down complex
         * queries into multiple search queries instead.
         */
        @Json(name = "operator")
