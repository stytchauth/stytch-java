...
public interface Passwords {
     ...
     * per second.
     *
     * The member's email will be marked as verified when you use this endpoint. If you are using **cross-organization
     * passwords**, call this method separately for each `organization_id` associated with the given `email_address` to ensure
     * the email is verified across all of their organizations.
     */
