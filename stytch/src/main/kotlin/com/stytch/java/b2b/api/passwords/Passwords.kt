...
public interface Passwords {
     ...
     *
     * We support migrating members from passwords stored with bcrypt, scrypt, argon2, MD-5, SHA-1, SHA-512, and PBKDF2. This
     ...
     *
     * If you are using **cross-organization passwords**, i.e. allowing an end user to share the same password across all of
     * their Organizations, call this method separately for each `organization_id` associated with the given `email_address`
     * to ensure the password is set across all of their Organizations.
     */
